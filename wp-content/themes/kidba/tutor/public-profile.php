	...
	if ( $is_instructor ) {
		...
		?>
			<div class="tutor-rating-container">      
				<div class="ratings">
					<div class="rating-generated d-inline-block">
						<?php tutor_utils()->star_rating_generator( $instructor_rating->rating_avg ); ?>
					</div>
					<div class='rating-digits d-inline-block'>
						<?php echo esc_html( number_format( $instructor_rating->rating_avg, 2 ) ); ?>
					</div> 
					<div class='rating-total-meta tutor-fs-7 tutor-color-muted d-inline-block'>
...
<?php $user_identifier = $is_instructor ? 'tutor-instructor' : 'tutor-student'; ?>
	<div <?php tutor_post_class( 'pt-90 pb-30 tutor-wrap-parent tutor-full-width-student-profile tutor-page-wrap tutor-user-public-profile tutor-user-public-profile-' . $profile_layout . ' ' . $user_identifier ); ?> >
					...
					if ( $is_instructor ) {
						...
						?>
							<span>
								...
								<?php $course_count > 1 ? _e( 'Courses', 'kidba' ) : _e( 'Course', 'kidba' ); ?>
							</span>
							<span>
								<span>•</span>
							</span>
							<span>
								...
								<?php $student_count > 1 ? _e( 'Students', 'kidba' ) : _e( 'Student', 'kidba' ); ?>
							</span>
						<?php
					} else {
						...
						?>
							...
							<?php $enrol_count > 1 ? _e( 'Courses Enrolled', 'kidba' ) : _e( 'Course Enrolled', 'kidba' ); ?>
							</span>
							<span><span>•</span></span>
							<span>
								<span><?php echo $complete_count; ?></span> 
							<?php $complete_count > 1 ? _e( 'Courses Completed', 'kidba' ) : _e( 'Course Completed', 'kidba' ); ?>
							</span>
							<?php
					}
					?>
		...
		<div class="tutor-container" style="overflow:auto">
			...
			<div class="tutor-user-profile-content tutor-d-block tutor-mt-72">
				<h3><?php _e( 'Biography', 'kidba' ); ?></h3>
				<?php tutor_load_template( 'profile.bio' ); ?>
				
				<?php
				if ( $is_instructor ) {
					?>
						<h3><?php _e( 'Courses', 'kidba' ); ?></h3>
						<?php
							add_filter(
								'courses_col_per_row',
								function() {
