...
$footer_links = array(
	array(
		'title'      => $is_instructor ? __( 'My Courses', 'kidba' ) : __( 'Dashboard', 'kidba' ),
		'url'        => $footer_url_1,
		'is_active'  => $footer_url_1 == $current_url,
		'icon_class' => 'ttr tutor-icon-dashboard',
	),
	array(
		'title'      => $is_instructor ? __( 'Q&A', 'kidba' ) : __( 'Quiz Attempts', 'kidba' ),
		'url'        => $footer_url_2,
...
<div class="tutor-wrap tutor-wrap-parent tutor-dashboard tutor-frontend-dashboard tutor-dashboard-student tutor-pb-80 pt-120">
				...
				<div class="tutor-d-flex tutor-align-center">
					...
					?>
						<a id="tutor-become-instructor-button" class="tutor-btn tutor-btn-outline-primary" href="<?php echo esc_url(tutor_utils()->instructor_register_url()); ?>">
							<i class="tutor-icon-user-bold"></i> &nbsp; <?php _e('Become an instructor', 'kidba'); ?>
						</a>
					<?php
					}
					...
					?>
						<a href="#" id="tutor-create-new-course" class="tutor-btn tutor-btn-outline-primary">
							<i class="tutor-icon-plus-square tutor-my-n4 tutor-mr-8"></i> <?php esc_html_e('Create a New Course', 'kidba'); ?>
						</a>
					<?php
						...
						__('Your Application is pending as of', 'kidba'), ' <b>', $on, '</b>',
						'</span>';
