...
if ( '0' === $comment->comment_approved ) { ?>
	...
	<p class="meta">
		<em class="woocommerce-review__awaiting-approval">
			<?php esc_html_e( 'Your review is awaiting approval', 'kidba' ); ?>
		</em>
	</p>

<?php } else { ?>

	<div class="kidba-comments-meta">
        <h4 class="class-comment-username mt--1 mb-10"><?php comment_author(); ?></h4>
		<?php
		if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
			echo '<em class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'kidba' ) . ')</em> ';
		}
